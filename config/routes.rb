...
ActionController::Routing::Routes.draw do |map|
  ...
  map.xml 'xml/:format/feed.xml', :controller => 'xml', :action => 'feed', :type => 'feed'
   ...
   map.xml 'xml/:format/fbfeed.xml', :controller => 'xml', :action => 'feed', :type => 'feed'
   map.xml 'xml/:format/:type/feed.xml', :controller => 'xml', :action => 'feed_internal'
   map.xml 'xml/:format/:type/fbfeed.xml', :controller => 'xml', :action => 'feed'
...
#         end
  ...
  map.connect '*from', :controller => 'redirect', :action => 'catcher'
end
